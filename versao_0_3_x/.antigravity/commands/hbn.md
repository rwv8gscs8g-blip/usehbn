# HBN Runtime Adapter for Antigravity command
...
Adapter refresh:
- After updating the HBN repository, refresh this runtime adapter with `hbn install --runtime antigravity --target <path> --force`.
