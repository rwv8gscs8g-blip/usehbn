# PROPOSTA — docs/GLOSSARY.md canônico (não-normativo até aplicado)

> Zona livre / untracked (knowledge 0024). Proposta de curadoria P0 a ser
> promovida por onda formal. Truth Barrier: cada definição é fiel ao disco e
> aponta para onde o termo é especificado hoje.

---

=== INÍCIO docs/GLOSSARY.md ===
