...
Adapters são arquivos de instrução em filesystem, não plugins nativos. Eles
instruem cada runtime a operar sob HBN, mas a execução real depende do runtime
ler e respeitar essas instruções. Estado atual: Implementado conforme
