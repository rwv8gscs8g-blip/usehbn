...
tipo: knowledge
path: versao_3_0_0/.hbn/knowledge/0022-firewall-workflow-fast-track.md
...
fonte: "destilado das fontes vivas que JÁ citavam este arquivo: core/relay-spec.md:128-129 («workflows só fast_track; escrita safe_track é humano-aplicada»), agents/role-templates.md §T1 («escrita VBA/domínio = safe_track humano-aplicada, sem exceção»; decisão Maurício, C1, 2026-06-10), invariante 1 do readback 0005 e nota da onda no STATE"
created_at: "2026-06-11T15:52:21-03:00"
---

# Firewall 0022 — o único invariante sempre-quente

Citado como sempre-quente por `agents/role-templates.md:29` e
`core/relay-spec.md:128` desde 2026-06-10, este arquivo NÃO EXISTIA no
disco (mesma classe do F-08/0019 — referência citada sem alvo). Este
depósito materializa a regra exatamente como as fontes vivas a enunciam;
em divergência, vale a decisão original de Maurício (C1, 2026-06-10).
...
4. Critério de sempre-quente (agents/role-templates.md:32-34): é crítico
   de segurança/negócio E não-coberto-por-guard-executável na parte
   "escrita fora de repo/commit" — por isso mora na read-list canônica
   de TODOS os papéis.
