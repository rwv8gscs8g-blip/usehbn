...
onda_atual: "P2-C FECHADO (commit b7b0baa no Credenciamento; runner project-mode + subset bloqueante; readback de projeto 0180; pre-commit verde). Readback 0104. Proximo: P2-C2 (reconciliacao do INDEX)."
...
proxima_acao: 'PASSO 2 / P2-C2: reconciliacao do INDEX da knowledge do projeto Credenciamento — assert-knowledge-index (genoma congelado) rejeita 20 entradas (7 ausentes: 0007,0008,0009,0013,0015,0016,0018; e 13 citadas so em markdown-link [x](x), que o regex (^|[ /|\])base($|[ /|`]) nao aceita); reformatar as citacoes do lado-projeto para forma aceita pelo guard e entao promover assert-knowledge-index de warning para bloqueante. P2-D depois.'
roadmap_ativo: "docs/brainstorm/rodada-2026-06-21/ROADMAP-macro-pos-blindagem-5-passos.md"
proximo_ponto:
  passo: 'PASSO 2 / P2-C2: reconciliacao do INDEX da knowledge do projeto Credenciamento — assert-knowledge-index (genoma congelado) rejeita 20 entradas (7 ausentes: 0007,0008,0009,0013,0015,0016,0018; e 13 citadas so em markdown-link [x](x), que o regex (^|[ /|\])base($|[ /|`]) nao aceita); reformatar as citacoes do lado-projeto para forma aceita pelo guard e entao promover assert-knowledge-index de warning para bloqueante. P2-D depois.'
  ato: implementacao
  destino: human
  gate: hearback_humano
  bloco_ref: .hbn/messages/20260630-140000-opus-4-8-despacho-onda-0104-repoint-p2c-fechado.md
  status: pendente
sinais_abertos:
...
readback_ativo: ".hbn/readbacks/0104-onda-repoint-state-p2c-fechado.json"
