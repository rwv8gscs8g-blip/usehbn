...
protocolo: "HBN 0.3.0 (muda 0.3.x -> 1.0.0 proposta; execução posterior)"
onda_atual: "onda 0010 — onda prévia Exúvia: proposta de protocolo de transição e plano da 1a muda"
bastao_token_sha256: 34a7f2f9882b7f4a8a5d54bfa40b957ae4369d8d3c4ba8bdbe52543b0d616daf
proprietario_bastao: codex
papel_bastao: "implementador da onda prévia Exúvia; desenho/readback do orquestrador claude-opus-4-8"
modo_educacional: "intermediário"
papeis:
  arquiteto: "claude-opus-4-8 — orquestrador/desenho da proposta Exúvia; distinto do implementador codex"
  auditor_validador_fixo: "gemini-3-5 — próxima auditoria cross-vendor do plano Exúvia; fornecedor Google ≠ implementador OpenAI"
...
proxima_acao: "cross-audit Gemini do plano da Exúvia; depois ratificação humana e onda de execução do corte"
sinais_abertos:
  ...
  - "🟢 SUÍTE 125/125 verde no SANDBOX Linux/Bash 5 nesta linha de trabalho (ver handoff/readback 0010); Bash 3.2/macOS: VERIFICAÇÃO TERMINAL PENDENTE — número do Terminal só entra aqui com saída colada pelo operador; BATERIA ADVERSARIAL 14/14 burlas BLOQUEADAS no sandbox (guards/tests/adversarial-battery.sh)"
...
readback_ativo: ".hbn/readbacks/0010-onda-previa-exuvia.json"
handoff_mais_recente: ".hbn/messages/20260614-001421-codex-handoff-onda-previa-exuvia.md"
...
ultima_atualizacao: "2026-06-14T00:14:21-03:00"
atualizado_por: codex-implementador-exuvia-0010
atribuicao:
  chapeu_atual: implementador
  implementador: codex
  auditores: [gemini-3-5]
  gravada_em: "2026-06-14T00:14:21-03:00"
  hearback_ref: null
---
...
Nota da onda prévia Exúvia (readback 0010): esta janela escreveu apenas a
proposta de protocolo de transição e plano da primeira muda 0.3.x -> 1.0.0.
Não houve congelamento, renascimento, baixa de F-01, hearback formal, edição
de guard, edição de src ou movimentação de estrutura. A ponte usehbn⇄
Credenciamento permanece vetada e fora do escopo.
