---
titulo: "Despacho — Selagem 0087 (Despromocao-P6 0086 vigente) — pronto para W-FREEZE"
tipo: despacho
status: proposto
temperatura: frio
path: .hbn/messages/20260621-110000-opus-4-8-despacho-selagem-0087.md
readback_alvo: 0087-selagem-despromocao
created_at: "2026-06-21T11:00:00-03:00"
...
relacionado:
  ...
  - .hbn/results/20260621-103000-antigravity-cross-ia-despromocao-p6-0086.md
  - .hbn/results/20260621-104000-grok-cross-ia-despromocao-p6-0086.md
  - guards/assert-quorum-selagem.sh
---

# HBN PEER REVIEW — Despacho Selagem 0087 (Despromocao-P6 vigente)

## RELATO DE ESTADO — opus-4-8 · orquestrador · 2026-06-21T11:00:00-03:00
SOU: opus-4-8 · familia Anthropic · papel orquestrador.
STATE: .hbn/relay/STATE.md ultima_atualizacao=2026-06-21T11:00:00-03:00 readback_ativo=.hbn/readbacks/0087-selagem-despromocao.json; DESPROMOCAO-P6 SELADO E VIGENTE; main intocada 4db6928; HEAD 4cd6bf8.
PRÓXIMA AÇÃO: W-FREEZE (freeze-gate.sh exit 0 pelo humano; tag v1-estavel)
SITUACAO: Despromocao-P6 ratificada (antigravity/Google + grok/xAI, APROVA_0086: SIM). Selagem 0087 sob G-QUORUM (seals_proposal 0086). Com isto, roadmap B concluido (W-ORQ-4 + Despromocao-P6); so resta o W-FREEZE.
BASTAO: opus-4-8 (Anthropic), atestação v2 valida.

## Decisões informais (cápsula)
- Quorum da Despromocao-P6 fechado: antigravity/Google + grok/xAI, ambos APROVA_0086: SIM (sem regressao na promocao).
- Selagem = ato de autoridade sob G-ORQ-REF (Exit A'); regenera atestacao same-fp; readback_ativo -> 0087; passa pelo G-QUORUM (seals_proposal 0086). proxima_acao: W-FREEZE (humano roda o freeze-gate, ja com o meta-deref do 4c).
...
HEAD esperado: 4cd6bf8. main DEVE estar em 4db692876381a0d7909985c8500d999f2e677b04 e NUNCA ser tocada.
READBACK A CRIAR: .hbn/readbacks/0087-selagem-despromocao.json (0087 = proximo monotonico apos 0086). DEVE conter "seals_proposal": "0086" (G-QUORUM exige).
...
C1. Stage dos 2 pareceres canonicos: .hbn/results/20260621-103000-antigravity-cross-ia-despromocao-p6-0086.md + .hbn/results/20260621-104000-grok-cross-ia-despromocao-p6-0086.md.
C2. EDITAR .hbn/relay/STATE.md (front-matter), trocando EXATAMENTE (resto intacto):
   - na string protocolo:, troque "Despromocao-P6 0086 entregue/proposto" por "Despromocao-P6 0086 selado e vigente via 0087; roadmap B pronto para W-FREEZE"
...
proximo_ponto:
  ...
  status: pendente
   - Nos sinais_abertos, substitua o sinal "🔴 EXCEÇÃO F-01 / Despromocao-P6 PROPOSED_UNTIL_CROSS_AUDIT — readback 0086 ..." por estes dois (no topo):
...
C3. CRIAR .hbn/readbacks/0087-selagem-despromocao.json com EXATAMENTE o scaffold do fim deste bloco (INCLUI seals_proposal: "0086").
...
C5. STAGE EXPLICITO (antes da atestacao): git add .hbn/relay/STATE.md .hbn/messages/20260621-110000-opus-4-8-despacho-selagem-0087.md .hbn/readbacks/0087-selagem-despromocao.json .hbn/results/20260621-103000-antigravity-cross-ia-despromocao-p6-0086.md .hbn/results/20260621-104000-grok-cross-ia-despromocao-p6-0086.md REGISTRY.md
C6. GERAR a atestacao com ESTE script (NAO a mao; readback_ativo->0087). Salve /tmp/gen_orq.py e rode `python3 /tmp/gen_orq.py`:
...
STAGE FINAL e COMMIT (um shot): git add .hbn/readbacks/0087-selagem-despromocao.json .hbn/messages/20260621-110000-opus-4-8-despacho-selagem-0087.md .hbn/results/20260621-103000-antigravity-cross-ia-despromocao-p6-0086.md .hbn/results/20260621-104000-grok-cross-ia-despromocao-p6-0086.md .hbn/relay/STATE.md REGISTRY.md .hbn/attestations/34a7f2f9-orq-entrada.json
Mensagem de commit (trailers contiguos no fim):
   chore: seal Despromocao-P6 (0086 vigente via 0087) — roadmap B pronto p/ W-FREEZE
...
## scaffold — .hbn/readbacks/0087-selagem-despromocao.json
{
  "readback_id": "0087-selagem-despromocao",
  "execution_id": "selagem-despromocao-2026-06-21",
  "agent_id": "codex",
  ...
  "path": ".hbn/readbacks/0087-selagem-despromocao.json",
  "orq_entrada_ref": ".hbn/attestations/34a7f2f9-orq-entrada.json",
  "dispatch_ref": ".hbn/messages/20260621-110000-opus-4-8-despacho-selagem-0087.md",
  "understanding": "Selar Despromocao-P6 (readback 0086) como vigente apos quorum != OpenAI (antigravity/Google + grok/xAI, ambos APROVA_0086: SIM) e hearback humano. Declara seals_proposal 0086 e trackea os 2 pareceres (G-QUORUM). Marca G-ARVORE-LABEL cobrindo promocao E despromocao; conclui o roadmap B (W-ORQ-4 + Despromocao-P6). REGISTRY e atestacao same-fp regenerada com readback_ativo->0087. proxima_acao: W-FREEZE (gate humano). Ato de autoridade sob G-ORQ-REF (Exit A').",
  "authorization": {
    "human": "Mauricio (Luis Mauricio Junqueira Zanin)",
    "evidence": "Hearback humano confirmado para a selagem 0087 (Despromocao-P6 0086) e tracking dos files_allowed no despacho de 2026-06-21T11:00:00-03:00.",
    "token_fp": "34a7f2f9"
  },
  "scope": {
    "files_allowed": [
      ".hbn/readbacks/0087-selagem-despromocao.json",
      ".hbn/messages/20260621-110000-opus-4-8-despacho-selagem-0087.md",
      ".hbn/results/20260621-103000-antigravity-cross-ia-despromocao-p6-0086.md",
      ".hbn/results/20260621-104000-grok-cross-ia-despromocao-p6-0086.md",
      ".hbn/relay/STATE.md",
      "REGISTRY.md",
  ...
  "stop_condition": "Selagem 0087 (Despromocao-P6 vigente) concluida; roadmap B pronto para W-FREEZE. NAO iniciar W-FREEZE (gate humano) neste commit.",
  "HBN-Readback": "0087",
  "HBN-Human-Authorization": "Mauricio (Luis Mauricio Junqueira Zanin)",
  "HBN-Token-FP": "34a7f2f9",
  "created_at": "2026-06-21T11:00:00-03:00",
