# HBN Runtime Adapter for Gemini command
...
Adapter refresh:
- After updating the HBN repository, refresh this runtime adapter with `hbn install --runtime gemini --target <path> --force`.
